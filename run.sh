...
IMAGE=kjobson/aslscp:0.1.3

# Command:
docker run -v /home/detrelab-adm/Downloads/ASLscp/input:/flywheel/v0/input -v \
	/home/detrelab-adm/Downloads/ASLscp/output:/flywheel/v0/output -v \
	/home/detrelab-adm/Downloads/ASLscp/work:/flywheel/v0/work -v \
	/home/detrelab-adm/Downloads/ASLscp/config.json:/flywheel/v0/config.json -v \
	/home/detrelab-adm/Downloads/ASLscp/manifest.json:/flywheel/v0/manifest.json \
